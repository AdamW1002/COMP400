; ModuleID = 'simple11.ll'
source_filename = "simple11.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@Test = private unnamed_addr constant [80 x i8] c"metadata i32* %bar.addr metadata !11 metadata !DIExpression() llvm.dbg.declare \00", align 1
@Test.1 = private unnamed_addr constant [17 x i8] c"llvm.dbg.declare\00", align 1
@Test.2 = private unnamed_addr constant [80 x i8] c"metadata i32* %bar.addr metadata !17 metadata !DIExpression() llvm.dbg.declare \00", align 1
@Test.3 = private unnamed_addr constant [17 x i8] c"llvm.dbg.declare\00", align 1
@Test.4 = private unnamed_addr constant [12 x i8] c"i32 %0 foo \00", align 1
@Test.5 = private unnamed_addr constant [4 x i8] c"foo\00", align 1
@Test.6 = private unnamed_addr constant [12 x i8] c"i32 0 foo2 \00", align 1
@Test.7 = private unnamed_addr constant [5 x i8] c"foo2\00", align 1
@Test.8 = private unnamed_addr constant [82 x i8] c"i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0) call printf \00", align 1
@Test.9 = private unnamed_addr constant [7 x i8] c"printf\00", align 1
@Test.10 = private unnamed_addr constant [75 x i8] c"metadata i8** %str metadata !28 metadata !DIExpression() llvm.dbg.declare \00", align 1
@Test.11 = private unnamed_addr constant [17 x i8] c"llvm.dbg.declare\00", align 1
@Test.12 = private unnamed_addr constant [17 x i8] c"i8* null printf \00", align 1
@Test.13 = private unnamed_addr constant [7 x i8] c"printf\00", align 1
...
entry:
  ...
  call void @__log_function__(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Test.1, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8], [80 x i8]* @Test, i32 0, i32 0))
...
entry:
  %bar.addr = alloca i32, align 4
  store i32 %bar, i32* %bar.addr, align 4
  call void @__log_function__(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Test.3, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8], [80 x i8]* @Test.2, i32 0, i32 0))
  ...
  call void @__log_function__(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @Test.5, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @Test.4, i32 0, i32 0))
...
entry:
  ...
  call void @__log_function__(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @Test.7, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @Test.6, i32 0, i32 0))
  %call = call i32 @foo2(i32 0), !dbg !26
  call void @__log_function__(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @Test.9, i32 0, i32 0), i8* getelementptr inbounds ([82 x i8], [82 x i8]* @Test.8, i32 0, i32 0))
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %call), !dbg !27
  call void @__log_function__(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Test.11, i32 0, i32 0), i8* getelementptr inbounds ([75 x i8], [75 x i8]* @Test.10, i32 0, i32 0))
  ...
  call void @__log_function__(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @Test.13, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Test.12, i32 0, i32 0))
