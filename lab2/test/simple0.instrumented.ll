...
@Test = private unnamed_addr constant [78 x i8] c"metadata i32* %b.addr metadata !11 metadata !DIExpression() llvm.dbg.declare \00", align 1
@Test.1 = private unnamed_addr constant [17 x i8] c"llvm.dbg.declare\00", align 1
@Test.2 = private unnamed_addr constant [82 x i8] c"metadata i8** %chars.addr metadata !21 metadata !DIExpression() llvm.dbg.declare \00", align 1
@Test.3 = private unnamed_addr constant [17 x i8] c"llvm.dbg.declare\00", align 1
@Test.4 = private unnamed_addr constant [9 x i8] c"i32 1 a \00", align 1
@Test.5 = private unnamed_addr constant [2 x i8] c"a\00", align 1
@Test.6 = private unnamed_addr constant [72 x i8] c"i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0) b \00", align 1
@Test.7 = private unnamed_addr constant [2 x i8] c"b\00", align 1
@Test.8 = private unnamed_addr constant [79 x i8] c"i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0) printf \00", align 1
@Test.9 = private unnamed_addr constant [7 x i8] c"printf\00", align 1
@Test.10 = private unnamed_addr constant [73 x i8] c"metadata i32* %x metadata !30 metadata !DIExpression() llvm.dbg.declare \00", align 1
@Test.11 = private unnamed_addr constant [17 x i8] c"llvm.dbg.declare\00", align 1
@Test.12 = private unnamed_addr constant [73 x i8] c"metadata i32* %y metadata !32 metadata !DIExpression() llvm.dbg.declare \00", align 1
@Test.13 = private unnamed_addr constant [17 x i8] c"llvm.dbg.declare\00", align 1
@Test.14 = private unnamed_addr constant [73 x i8] c"metadata i32* %w metadata !35 metadata !DIExpression() llvm.dbg.declare \00", align 1
@Test.15 = private unnamed_addr constant [17 x i8] c"llvm.dbg.declare\00", align 1
@Test.16 = private unnamed_addr constant [73 x i8] c"metadata i32* %z metadata !39 metadata !DIExpression() llvm.dbg.declare \00", align 1
@Test.17 = private unnamed_addr constant [17 x i8] c"llvm.dbg.declare\00", align 1
...
entry:
  ...
  call void @__log_function__(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Test.3, i32 0, i32 0), i8* getelementptr inbounds ([82 x i8], [82 x i8]* @Test.2, i32 0, i32 0))
...
entry:
  ...
  call void @__log_function__(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @Test.5, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @Test.4, i32 0, i32 0))
  %call = call i32 @a(i32 1), !dbg !27
  call void @__log_function__(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @Test.7, i32 0, i32 0), i8* getelementptr inbounds ([72 x i8], [72 x i8]* @Test.6, i32 0, i32 0))
  %call1 = call i32 @b(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0)), !dbg !28
  call void @__log_function__(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @Test.9, i32 0, i32 0), i8* getelementptr inbounds ([79 x i8], [79 x i8]* @Test.8, i32 0, i32 0))
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)), !dbg !29
  call void @__log_function__(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Test.11, i32 0, i32 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @Test.10, i32 0, i32 0))
  call void @llvm.dbg.declare(metadata i32* %x, metadata !30, metadata !DIExpression()), !dbg !31
  store i32 0, i32* %x, align 4, !dbg !31
  call void @__log_function__(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Test.13, i32 0, i32 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @Test.12, i32 0, i32 0))
  ...
  call void @__log_function__(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Test.15, i32 0, i32 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @Test.14, i32 0, i32 0))
  ...
  call void @__log_function__(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Test.17, i32 0, i32 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @Test.16, i32 0, i32 0))
  ...
  call void @__sanitize__(i32 %2, i32 27, i32 13)
